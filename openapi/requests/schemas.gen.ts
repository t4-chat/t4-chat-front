...
export const $AdminMessageRequestSchema = {
  properties: {
    content: {
      type: "string",
      title: "Content",
  ...
  type: "object",
  required: ["content"],
  title: "AdminMessageRequestSchema",
} as const;

export const $AdminSendMessageRequestSchema = {
  properties: {
    model_id: {
      type: "string",
      format: "uuid",
  ...
  title: "AdminSendMessageRequestSchema",
} as const;

export const $AdminSendMessageResponseSchema = {
  properties: {
    text: {
      type: "string",
      title: "Text",
  ...
  type: "object",
  required: ["text"],
  title: "AdminSendMessageResponseSchema",
} as const;
...
export const $HostAiModelAssociationSchema = {
  ...
  type: "object",
  required: ["model_id", "model_slug", "priority"],
...
export const $ModelHostAssociationSchema = {
  properties: {
    ...
    model_slug: {
      type: "string",
      title: "Model Slug",
      description: "The slug of the model on this host",
    },
    priority: {
      type: "integer",
      title: "Priority",
  ...
  type: "object",
  required: ["host_id", "model_slug", "priority"],
