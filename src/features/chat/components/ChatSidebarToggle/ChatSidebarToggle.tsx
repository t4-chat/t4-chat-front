...
const ChatSidebarToggle = ({ onClick }: ChatSidebarToggleProps) => {
  return (
    <Button
      ...
      className="top-4 left-4 fixed z-fixed-low shadow-[0_0.125rem_0.25rem_rgba(0,0,0,0.1)] hover:shadow-[0_0.25rem_0.5rem_rgba(0,0,0,0.15)] rounded-full w-10 h-10"
    >
