...
export const ChatSidebarFloatingButtons = ({
  ...
  return (
    <div className="top-3 left-3 z-[9] fixed flex items-center gap-2">
      ...
      <button
        type="button"
        className="flex justify-center items-center bg-[var(--primary-color)] hover:bg-[var(--primary-color-hover)] shadow-[0_0.125rem_0.25rem_rgba(0,0,0,0.1)] hover:shadow-[0_0.25rem_0.5rem_rgba(0,0,0,0.15)] border-none rounded-full w-10 h-10 text-white transition-all duration-200 cursor-pointer"
