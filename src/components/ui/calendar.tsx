    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_next: cn(
          ...
          "h-7 w-7 [&_svg]:w-4 [&_svg]:h-4 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-1 [&_svg]:fill-foreground",
          classNames?.button_next,
        ),
        button_previous: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 [&_svg]:w-4 [&_svg]:h-4 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-1 [&_svg]:fill-foreground",
