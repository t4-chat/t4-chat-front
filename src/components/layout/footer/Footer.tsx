...
export const Footer = () => {
  ...
  const getThemeIcon = (theme: ThemeType) => {
    switch (theme) {
      case 'light': return '🌙'; // Show moon icon to switch to dark
      case 'dark': return '☀️'; // Show sun icon to switch to light
      default: return '⚙️';
    }
  };
  ...
  return (
    <footer className="footer">
      <div className="footer__content">
        <p className="footer__copyright">&copy; 2024 AGG AI. All rights reserved.</p>
        <button 
